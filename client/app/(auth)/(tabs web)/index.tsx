...
import { StyleSheet, View, Text, TouchableOpacity, Modal, ActivityIndicator, Keyboard, Image, Button, TextInput} from 'react-native';
...
import StatusWeb from '@/components/Home/StatusWeb';
import FeedbackWeb from '@/components/Home/FeedbackWeb';
import HallOfShameAndFame from '@/components/Home/HallOfShameAndFameWeb';
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.rightRectanglesContainer}>
        {user && ( // Only show reservation info if logged in
          <View style={styles.flexBoxesRight}>
                <StatusWeb setModalVisible={setModalVisible} />
                <FeedbackWeb isModalVisible={isModalVisible} setModalVisible={setModalVisible} />
          </View>
        )}
        <ReportProblemModal />
      </View>
